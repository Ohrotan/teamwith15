...
public class TeamDetailViewVO {
	...
	public TeamDetailViewVO() {
		super();
	}
	public TeamDetailViewVO(String teamId, String teamProjectName, String teamName, String teamSummary,
			String teamContent, String projectCategoryId, String regionId, Date teamEndDate, int teamStatus,
			String teamPic, String teamContestName, String teamContestLink, String memberId, String memberPic,
			String roleId) {
		super();
		this.teamId = teamId;
	...
	public String toString() {
		return "TeamDetailViewVO [teamId=" + teamId + ", teamProjectName=" + teamProjectName + ", teamName=" + teamName
				...
				+ teamContestLink + ", memberId=" + memberId + ", memberPic=" + memberPic + ", roleId=" + roleId + "]";
	}
	public int hashCode() {
		final int prime = 31;
		int result = 1;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TeamDetailViewVO other = (TeamDetailViewVO) obj;
		if (memberId == null) {
