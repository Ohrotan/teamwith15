...
public class PologService2 {
	
	private static PologService2 pologServiceDao;
	static {
		pologServiceDao = new PologService2();
	}
	
	private PologService2(){
		
	}
	public static PologService2 getInstance(){
	...
	public PologVO searchPolog(String memberId){
		...
		if(MemberService.getInstance().isPublic(memberId)!=0){
			return null;
		}
	...
	public List<PortfolioSimpleVO> searchMemberPortfolio(String memberId){
		if(isNull(new Object[]{memberId})|| MemberService.getInstance().isMember(memberId) != 0){
			return null;
		}
		Connection con=null;
		PreparedStatement pstmt=null;
	...
	public int addMemberPortfolio(String memberId,String portfolioTitle,String portfolioProjectIntro,Timestamp portfolioStartDate,
		...
		if(isNull(new Object[]{portfolioTitle,portfolioSkill,projectCategoryId })
				||portfolioBest<0||portfolioBest>1|| MemberService.getInstance().isMember(memberId) != 0){
			return 2;
		}
		Connection con=null;
		PreparedStatement pstmt=null;
	...
	public int updatePologInfo(String memberId, PologVO polog){
		if(isNull(new Object[]{memberId,polog})|| MemberService.getInstance().isMember(memberId) != 0){
			return 2;
		}
		Connection con=null;
		PreparedStatement pstmt=null;
