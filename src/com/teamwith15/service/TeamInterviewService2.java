...
public class TeamInterviewService2 {
	private static TeamInterviewService2 teamInterviewDao;
	
	static {
		teamInterviewDao = new TeamInterviewService2();
	}
	
	private TeamInterviewService2() {
	}

	public static TeamInterviewService2 getInstance() {
