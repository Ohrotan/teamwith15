...
public class TeamInterviewService {
	private static TeamInterviewService teamInterviewDao;
	
	static {
		teamInterviewDao = new TeamInterviewService();
	}
	
	private TeamInterviewService() {
	}

	public static TeamInterviewService getInstance() {
